...
function PortfolioPage() {
  ...
  // State to store the available sections for the current user
  const [availableSections, setAvailableSections] = useState([]);

  // Fetch the available sections when the component mounts
  const fetchUserSections = async (userId) => {
    try {
      const response = await axios.get(`http://localhost:8800/api/portfolio/getUserSections?userId=${userId}`);
        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav">
              ...
              {availableSections.includes("skills") && (
                <li className="nav-item">
          ...
          {availableSections.includes("education") && (
            <section className="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
              <div className="my-auto">
                ...
                {/* student data fetched from unidomain */}
